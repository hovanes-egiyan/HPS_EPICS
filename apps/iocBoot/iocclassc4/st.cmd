...
dbLoadRecords("db/sixty_hz_common.db", "FIFO=2048, HALF_FIFO=2048")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=0")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=1")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=2")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=3")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=4")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=5")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=6")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=7")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=8")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=9")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=10")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=11")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=12")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=13")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=14")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=15")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=16")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=17")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=18")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=19")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=20")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=21")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=22")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=23")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=24")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=25")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=26")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=27")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=28")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=29")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=30")
dbLoadRecords("db/sixty_hz_macro.db", "FIFO=2048, HALF_FIFO=2048, CHAN=31")
